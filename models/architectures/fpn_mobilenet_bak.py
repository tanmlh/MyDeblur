...
def conv_nxn(num_in, num_out):
    return nn.Conv2d(num_in, num_out, kernel_size=7)
...
class FPNMobileNet(nn.Module):
    ...
    def __init__(self, norm_type='instance', output_ch=3, num_filters=64, num_filters_fpn=128, pretrained=False):
        super().__init__()
